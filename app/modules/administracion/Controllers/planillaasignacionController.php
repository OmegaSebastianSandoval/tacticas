...
*/
class Administracion_planillaasignacionController extends Administracion_mainController
{
	/**
	 ...
	 * @var string
	 */
	protected $_csrf_section = "administracion_planillaasignacion";
	...
	{
		$this->mainModel = new Administracion_Model_DbTable_Planillaasignacion();
		$this->namefilter = "parametersfilterplanillaasignacion";
		$this->route = "/administracion/planillaasignacion";
	...
	{
		$title = "Administración de planilla asignaci&oacute;n";
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['sin_seguridad'] =  $this->_getSanitizedParam("sin_seguridad");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
