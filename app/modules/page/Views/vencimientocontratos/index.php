                    ...
                    <?php foreach ($this->lists as $content) { ?>
                        ...
                        <?php if ($content->nombres != '') { ?>
                            ...
                            <tr>
                                ...
                                <td><?= $this->list_tipo[$content->tipo_contrato];  ?></td>

                                <?php


                                if ($content->tipo_contrato == 2) {
                                    $meses2 = 6;
                                }
                                if ($content->tipo_contrato == 3) {
                                    $meses2 = 12;
                                }
                                $fecha = $content->fecha_ingreso;
                                $nuevafecha = strtotime('+' . $meses2 . ' month', strtotime($fecha));
                                $fecha_vencimiento = date('Y-m-d', $nuevafecha);

                                if ($content->tipo_contrato == "5") {
                                    $fecha = $content->inicio;
                                    $fecha_vencimiento = $content->fin;
                                }
                                ?>
                                ...
                                <?php
                                $hoy=date('Y-m-d');
                                $dif = diferencia($hoy, $fecha_vencimiento);
                                ?>
                                <td class="<?php echo vencimiento3($dif); ?>">  <?php echo $dif; ?></td>
