		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-3 form-group d-grid">
					<label class="control-label">&iquest;Solo admin?</label>
					<input type="checkbox" name="solo_admin" value="1" class="form-control switch-form " <?php if ($this->getObjectVariable($this->content, 'solo_admin') == 1) {
																												echo "checked";
																											} ?>></input>
					<div class="help-block with-errors"></div>
				</div>
