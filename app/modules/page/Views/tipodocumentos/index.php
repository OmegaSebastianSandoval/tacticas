	...
	<form action="<?php echo $this->route; ?>" method="post">
		<div class="content-dashboard">
			<div class="row">
				...
				<!-- <div class="col-3">
		            <label>&iquest;Solo admin?</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="solo_admin" value="<?php echo $this->getObjectVariable($this->filters, 'solo_admin') ?>"></input>
		            </label>
		        </div> -->
				<div class="col-2  d-flex align-items-end ">
					<label>&nbsp;</label>
					<button type="submit" class="btn btn-grid btn-azul"> <i class="fas fa-filter"></i> Filtrar</button>
				</div>
				<div class="col-2  d-flex align-items-end ">
					<label>&nbsp;</label>
					<a class="btn btn-grid btn-azul-claro " href="<?php echo $this->route; ?>?cleanfilter=1"> <i class="fas fa-eraser"></i> Limpiar Filtro</a>
				</div>
			</div>
		</div>
	</form>
