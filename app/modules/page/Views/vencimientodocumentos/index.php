            ...
            <tbody>
                <?php foreach ($this->lists as $content) { ?>
                    ...
                    <tr>
                        ...
                        <td> <a href="/files/<?php echo $content->archivo; ?>" target="_blank"> <?= $content->nombre; ?></a></td>
                        <td><?= $this->list_empresa[$content->empresa]; ?>
                        <td><?= $this->list_tipo[$content->tipo];?></td>

                        <td> <?= $content->fecha; ?></td>
                        <td class="<?php echo vencimiento($content->fecha_vencimiento)?>" > <?php if($content->fecha_vencimiento !='0000-00-00'){ echo $content->fecha_vencimiento;} ?></td>
                        ...
                        <td class="text-right">
                            <div>
                                <a class="btn btn-azul btn-sm" href="/page/documentoshojadevida/manage?id=<?= $id ?>&seccion=1" data-bs-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pen-alt"></i></a>
