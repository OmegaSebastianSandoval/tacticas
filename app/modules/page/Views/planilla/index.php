	...
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            <label>limite_dominicales</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rojo-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="limite_dominicales" value="<?php echo $this->getObjectVariable($this->filters, 'limite_dominicales') ?>"></input>
		            </label>
		        </div>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->cerrada;?></td>
						<td><?=$content->fecha_cerrada;?></td>
						<td><?=$content->limite_horas;?></td>
						<td><?=$content->limite_dominicales;?></td>
						<td class="text-right">
							<div>
