...
<div class="container h-100">
    ...
    <div class="row  h-100">
        <div class="col-md-6 d-flex justify-content-center  align-items-end align-items-md-center">

            <h1 class="titulo-login">Sistema de nómina</h1>
        </div>
        <div class="col-md-6 d-flex justify-content-center  align-items-start align-items-md-center">
            <form class="form-login shadow rounded-lg pb-4" autocomplete="off" action="/page/index/validar" method="post">
                ...
                <div class="body-form px-3 text-center">
                    ...
                    <?php } ?>
                    <div class="d-none">
                        <a href="/page/index/recuperar" class="">¿Olvidó su contraseña?</a>
                    </div>
