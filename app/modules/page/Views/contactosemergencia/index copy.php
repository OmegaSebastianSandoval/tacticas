        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_emergencia_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_emergencia_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_emergencia_telefono" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_emergencia_telefono') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_emergencia_parentesco" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_emergencia_parentesco') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contacto_emergencia_empleado" value="<?php echo $this->getObjectVariable($this->filters, 'contacto_emergencia_empleado') ?>"></input>
		            </label>
		        </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->contacto_emergencia_id; ?>
					<tr>
						<td><?=$content->contacto_emergencia_nombre;?></td>
						<td><?=$content->contacto_emergencia_telefono;?></td>
						<td><?=$content->contacto_emergencia_parentesco;?></td>
						<td><?=$content->contacto_emergencia_empleado;?></td>
						<td class="text-right">
							<div>
