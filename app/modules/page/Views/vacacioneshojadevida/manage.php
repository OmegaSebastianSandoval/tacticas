		...
		<div class="content-dashboard">
			...
			<div class="row">
				<div class="col-6 form-group">
					...
					<input type="date" value="<?php if($this->content->fecha1){ echo $this->content->fecha1; }  ?>" name="fecha1" id="fecha1" class="form-control"  required  data-date-format="yyyy-mm-dd" data-date-language="es"  >
					</label>
				...
				<div class="col-6 form-group">
					...
					<input type="date" value="<?php if($this->content->fecha2){ echo $this->content->fecha2; }  ?>" name="fecha2" id="fecha2" class="form-control"    data-date-format="yyyy-mm-dd" data-date-language="es"  >
					</label>
					<div class="help-block with-errors"></div>
				</div>
