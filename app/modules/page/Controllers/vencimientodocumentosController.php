 ...
 */
class Page_vencimientodocumentosController extends Page_mainController
{
	public $botonpanel = 4;
	 ...
	 * @var string
	 */
	protected $_csrf_section = "page_vencimientodocumentos";
	...
	public function init()
	{
		...
		$this->namefilter = "parametersfiltervencimientodocumentos";
		$this->route = "/page/vencimientodocumentos";
		$this->namepages = "pages_vencimientodocumentos";
		$this->namepageactual = "page_actual_vencimientodocumentos";
	...
	public function indexAction()
	{
		...
		$list = $this->mainModel->getDocumentos($filters, $order);
		...
		$this->_view->lists = $this->mainModel->getListPagesDocumentos($filters, $order, $start, $amount);
