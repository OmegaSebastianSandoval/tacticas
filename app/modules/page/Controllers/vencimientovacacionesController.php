 ...
 */
class Page_vencimientovacacionesController extends Page_mainController
{
	public $botonpanel = 4;
	 ...
	 * @var string
	 */
	protected $_csrf_section = "page_vencimientovacaciones";
	...
	public function init()
	{
		...
		$this->namefilter = "parametersfiltervencimientovacaciones";
		$this->route = "/page/vencimientovacaciones";
		$this->namepages = "pages_vencimientovacaciones";
		$this->namepageactual = "page_actual_vencimientovacaciones";
	...
	public function indexAction()
	{
		...
		$order = "fecha2 ASC";
		$list = $this->mainModel->getVacaciones($filters, $order);
		...
		$this->_view->lists = $this->mainModel->getListPagesVacaciones($filters, $order, $start, $amount);
