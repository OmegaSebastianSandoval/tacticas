	...
	public function getListCedulas($filters = '', $order = '')
	{
	  ...
	  if ($order != '') {
		$orders = ' ORDER BY ' . $order;
		 ...
		 $select = 'SELECT planilla_asignacion.*, hoja_vida.metodo_pago,  hoja_vida.numero_cuenta, CONCAT(hoja_vida.nombres," ",hoja_vida.apellidos) AS nombre1 FROM planilla_asignacion LEFT JOIN hoja_vida ON hoja_vida.documento = planilla_asignacion.cedula ' . $filter . ' ' . $orders;
