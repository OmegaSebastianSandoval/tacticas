...
*/
class Page_Model_DbTable_Historialcontratos extends Db_Table
{
	/**
	...
	public function insert($data){
		$historial_contratos_fecha_inicio = $data['inicio'];
		$historial_contratos_fecha_fin = $data['fin'];
		$historial_contratos_cedula = $data['cedula'];
